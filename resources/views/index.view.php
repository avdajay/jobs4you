        ...
        <div class="sixteen columns">
            <div class="search-container">
                ...
                <div class="browse-jobs">
                    ...
                    <!--<a href="browse-categories.html"> category</a>--> <a href="<?php url('/browse-locations') ?>">location</a>
                </div>
                            ...
                            <?php if (isset($job['featured_at'])) : ?>
                                <li>
                                    <div class="job-spotlight">
                                        <a href="<?php url('/job?id=' . $job['id']) ?>">
                                            <h4><?php e($job['job_title']) ?> <span class="<?php e(slug($job['etype'])) ?>"><?php e($job['etype']) ?></span></h4>
                                        </a>
